...
<br><br><br>
								...
								<input type="text" class="form-control" id="name" name='comp_name'>
							</div>
              <div class="form-group">
								<label for="message">Idea*</label>
								<input name="" id="message" cols="30" rows="10" class="form-control" name='idea'>
							</div>
              ...
              <div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="email" name='financial'>
							</div>
							<div class="form-group">
								<label for="">Man-Power Need</label>
								<input type="text" class="form-control" id="email" name='manpower'>
							</div>
							<div class="form-group">
